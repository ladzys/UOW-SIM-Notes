...
DROP TABLE servicedBy;
DROP TABLE loan;
DROP TABLE serviceProvider;
DROP TABLE camera;
DROP TABLE damagePayment;
DROP TABLE employee;
DROP TABLE item;
...
-- INSERT INTO employee VALUES ('984816984', 'Justin Foo', 'M', '82848610', ' Justinfoo78@gmail.com');
-- INSERT INTO item VALUES ('S484518FD', 'broken', 'G2000FE', 'Customer have not pay', 'On loan');
-- INSERT INTO item (serial_no) VALUES ('S451826FG');
-- INSERT INTO damagePayment (ref_no, amount) VALUES ('SGF094057', 800);

-- For Checking Only
SELECT * FROM item;
SELECT * FROM employee;
SELECT * FROM damagePayment;
SELECT * FROM camera;
SELECT * FROM serviceProvider;
SELECT * FROM loan;
SELECT * FROM servicedBy;